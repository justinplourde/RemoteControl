using ClientHostOptions = LocationRemote.Client.Host.HostOptions;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using ServerHostOptions = LocationRemote.Server.Host.HostOptions;
using System;

namespace LocationRemote.Host.Tests
{
    [TestClass]
