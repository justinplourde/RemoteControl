    ...
    public class DefaultCommandSafetyClassifierTests
    {
        ...
        public void SensitiveParityTargetCommandsRequirePermissionAndConsent()
        {
            ...
            var commands = new Dictionary<IMessage, CommandSafetyClass>
            {
                ...
                [new GetDesktop { CreateNew = true, Quality = 80, DisplayIndex = 0 }] = CommandSafetyClass.RemoteCapture,
            ...
            Assert.IsTrue(classifier.Classify(new GetDesktop { CreateNew = true, Quality = 80, DisplayIndex = 0 }).RequiresConsent);
